...
Texture::Texture(const std::string& filePath) :
	...
	reflectivity(1.0f),Shinedamper(10.0f)
{
...
void Texture::setReflectivity(float ref)
{
	reflectivity = ref;
}

void Texture::setShineDampner(float shine)
{
	Shinedamper = shine;
}

float Texture::returnShineDampner()
{
	return Shinedamper;
}

float Texture::returnReflectivity()
{
	return reflectivity;
}
